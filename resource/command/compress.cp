##commandParserV1.0
##programName=<value="bgzip compress <input>";description="when '-h' were passed in, would be show 'Usage: $value [options]'">
##debugMode=false
...
compress	true	string	string	EnsureFileExists;NotDirectory	1	Options	.	.	true	false	false
