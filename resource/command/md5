##commandParserV1.0
##programName=<value="bgzip md5 <input>";description="when '-h' were passed in, would be show 'Usage: $value [options]'">
##debugMode=false
...
md5	true	string-array	string	EnsureFileExists;NotDirectory	1	Options	.	.	true	false	false