...
public class CommandParserDesigner extends JFrame {
    ...
    private Array<Object[]> commandBackupList;
    private Array<Object[]> ruleBackupList;
    ...
    public void addListener() {
        ...
        searchBox.addActionListener(e -> {
            ...
            if (filter.length() == 0) {
                ...
                commandModel.data = new Array<>();
                ruleModel.data = new Array<>();
                commandModel.flush();
                ruleModel.flush();
                if (filter.contains(":")) {
                    // 识别为 列名:值 形式
    ...
    void toJavaFile(String outputFileName) {
        ...
        Array<Object[]> copy = commandBackupList == null ? commandModel.data : commandBackupList;
        for (Object[] row : copy) {
            if (".".equals(row[0])) {
                continue;
            }

            Array<String> commandScript = new Array<>();
