...
public class BiDict<K, V> implements Cloneable{
    ...
    @Override
    public BiDict<K, V> clone() {
        BiDict bd = new BiDict<>();
        bd.keys = (HashMap<K, V>) this.keys.clone();
        bd.values = (HashMap<V, K>) this.values.clone();
