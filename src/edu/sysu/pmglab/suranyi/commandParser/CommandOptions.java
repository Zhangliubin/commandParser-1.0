...
import edu.sysu.pmglab.suranyi.commandParser.validator.IValidator;
...
public enum CommandOptions {
     ...
     */
    final static Pattern COMMAND_NAME_RULE = Pattern.compile("(^[a-zA-Z0-9+_\\-@]+$)|(^[a-zA-Z0-9+_\\-@][a-zA-Z0-9+_\\-@.]+$)");
