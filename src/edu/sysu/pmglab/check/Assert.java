...
public final class Assert {
    ...
    public static boolean that(boolean condition) {
        return that(condition, RuntimeExceptionOptions.AssertionError);
    }
    ...
    public static boolean that(boolean condition, String reason) {
        return that(condition, RuntimeExceptionOptions.AssertionError, reason);
    }
    ...
    public static <T> T NotNull(T obj) {
        that(obj != null, RuntimeExceptionOptions.NullPointerException);
        return obj;
    }
    ...
    public static <T> T[] NotEmpty(T[] obj) {
        ...
        that(condition, RuntimeExceptionOptions.EmptyArrayException);
        return obj;
    }
    ...
    public static <E> Collection<E> NotEmpty(Collection<E> obj) {
        ...
        that(condition, RuntimeExceptionOptions.EmptyCollectionException);
        return obj;
    }
    ...
    public static String NotEmpty(String obj) {
        boolean condition = obj != null && obj.length() > 0;
        that(condition, RuntimeExceptionOptions.EmptyStringException);
        return obj;
    }
    ...
    public static <K, V> Map<K, V> NotEmpty(Map<K, V> obj) {
        boolean condition = obj != null && obj.size() > 0;
        that(condition, RuntimeExceptionOptions.EmptyMapException);
        return obj;
    }
    ...
    public static byte NotNegativeValue(byte value) {
        that(value >= 0, RuntimeExceptionOptions.NegativeValueException, "value cannot be negative");
        return value;
    }
    ...
    public static byte valueRange(byte value, byte minValue, byte maxValue) {
        ...
        that(condition, RuntimeExceptionOptions.ArgumentOutOfRangeException, "value out of range [" + minValue + ", " + maxValue + "]");
        return value;
    }
    ...
    public static int arrayIndex(int index, int offset, int length) {
        ...
        that(condition, RuntimeExceptionOptions.ArrayIndexOutOfBoundsException, "arrayIndex out of range [" + offset + ", " + (offset + length - 1) + "]");
        return index;
    }
}
