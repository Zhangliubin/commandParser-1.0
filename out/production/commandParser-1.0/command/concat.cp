##commandParserV1.0
##programName=<value="bgzip concat <input(s)>";description="when '-h' were passed in, would be show 'Usage: $value [options]'">
##debugMode=true
...
concat	true	string-array	string	EnsureFileExists;NotDirectory	1	Options	.	.	true	false	false
